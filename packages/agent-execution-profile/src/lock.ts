...
import type { ExecutionProfile, ExecutionProfileLock } from "./types.js";

export function buildExecutionProfileLock(profile: ExecutionProfile): ExecutionProfileLock {
  const lock: ExecutionProfileLock = {
...
export function executionProfileLockDigest(lock: ExecutionProfileLock) {
