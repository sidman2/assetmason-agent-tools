...
## `packages/ai-discovery/package.json`

- version: `0.1.0-preview.0`
- private value: absent
- publishable from package metadata: yes
- bin value: `{ "ai-discovery": "bin/ai-discovery.js" }`
...
- `npm publish --dry-run --tag preview` succeeded for `ard-kit`, `ard-cli`, and `ai-discovery`.
