...
describe("release-evidence", () => {
  it("reports the current public verification surface without mutation", () => {
    ...
    expect(evidence.packages["agent-resource-plan"].version).toBe("0.1.0-preview.5");
    expect(evidence.packages["agent-execution-profile"].version).toBe("0.1.0-preview.5");
    expect(evidence.packages["assetmason-cli"].version).toBe("0.1.0-preview.5");
